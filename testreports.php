									...
									<table class="table table-custom table-centered table-select table-hover w-100 mb-0" id="test1">
										...
										<tbody>
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB20100</a></h5>
												</td>
												...
												<td><img src="../source/inspinia5/assets/images/cards/visa.svg" alt="" class="me-2" height="28" /> xxxx 7832</td>
												<td>
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB20101</a></h5>
												</td>
												...
												<td>
													<img src="../source/inspinia5/assets/images/cards/mastercard.svg" alt="" class="me-2" height="28" />
													xxxx 5487
												</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB20102</a></h5>
												</td>
												<td>26 Apr, 2025 <small class="text-muted">1:20 PM</small></td>
												<td>
													<div class="d-flex justify-content-start align-items-center gap-2">
														<div class="avatar avatar-sm">
															<img src="../source/inspinia5/assets/images/users/user-1.jpg" alt="avatar-1" class="img-fluid rounded-circle" />
														</div>
														<div>
												...
												<td>
													<img src="../source/inspinia5/assets/images/cards/paypal.svg" alt="" class="me-2" height="28" />
													xxx@email.com
												</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB20103</a></h5>
												</td>
												<td>27 Apr, 2025 <small class="text-muted">3:30 PM</small></td>
												<td>
													<div class="d-flex justify-content-start align-items-center gap-2">
														<div class="avatar avatar-sm">
															<img src="../source/inspinia5/assets/images/users/user-10.jpg" alt="avatar-10" class="img-fluid rounded-circle" />
														</div>
														<div>
												...
												<td><img src="../source/inspinia5/assets/images/cards/stripe.svg" alt="" class="me-2" height="28" /> xxxx 9901</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
														<a href="apps-ecommerce-order-details.php" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
														<a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB20104</a></h5>
												</td>
												<td>28 Apr, 2025 <small class="text-muted">9:55 AM</small></td>
												<td>
													<div class="d-flex justify-content-start align-items-center gap-2">
														<div class="avatar avatar-sm">
															<img src="../source/inspinia5/assets/images/users/user-5.jpg" alt="avatar-11" class="img-fluid rounded-circle" />
														</div>
														<div>
												...
												<td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
												<td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
												<td><img src="../source/inspinia5/assets/images/cards/american-express.svg" alt="" class="me-2" height="28" /> xxxx 4678</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
														<a href="apps-ecommerce-order-details.php" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
														<a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB30100</a></h5>
												</td>
												<td>20 Apr, 2025 <small class="text-muted">2:30 PM</small></td>
												<td>
													<div class="d-flex justify-content-start align-items-center gap-2">
														<div class="avatar avatar-sm">
															<img src="../source/inspinia5/assets/images/users/user-3.jpg" alt="avatar-3" class="img-fluid rounded-circle" />
														</div>
														<div>
												...
												<td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
												<td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
												<td><img src="../source/inspinia5/assets/images/cards/discover-card.svg" alt="" class="me-2" height="28" /> xxxx 1234</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
														<a href="apps-ecommerce-order-details.php" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
														<a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB30101</a></h5>
												</td>
												...
												<td><span class="badge badge-soft-warning fs-xxs">Processing</span></td>
												<td>
													<img src="../source/inspinia5/assets/images/cards/unionpay.svg" alt="" class="me-2" height="28" />
													xxxx 9876
												</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB30102</a></h5>
												</td>
												...
												<td><span class="badge badge-soft-danger fs-xxs">Cancelled</span></td>
												<td>
													<img src="../source/inspinia5/assets/images/cards/payoneer.svg" alt="" class="me-2" height="28" />
													xxx@email.com
												</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB30103</a></h5>
												</td>
												...
												<td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
												<td><span class="badge badge-soft-info fs-xxs">Shipped</span></td>
												<td><img src="../source/inspinia5/assets/images/cards/google-wallet.svg" alt="" class="me-2" height="28" /> xxx@google</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
														<a href="apps-ecommerce-order-details.php" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
														<a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
											...
											<tr>
												...
												<td>
													<h5 class="fs-sm mb-0 fw-medium"><a href="apps-ecommerce-order-details.php" class="link-reset">#WB30104</a></h5>
												</td>
												...
												<td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
												<td>
													<img src="../source/inspinia5/assets/images/cards/bhim.svg" alt="" class="me-2" height="28" />
													xxxx@upi
												</td>
												<td>
													<div class="d-flex justify-content-center gap-1">
