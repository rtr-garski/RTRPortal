                        ...
                        <div class="col-lg-12">
                            ...
                            <form class="bg-light-subtle rounded border p-3">
                                <div class="d-flex flex-wrap justify align-items-center gap-3">
                                    ...
                                    <div class="mb-0 fs-xl flex-grow-1">Order #<?= htmlspecialchars($order['__kp_API_Input_Order_ID']) ?><br/><small class="text-muted">Ordered on <?= date('d M, Y', strtotime($order['API_Input_Timestamp'])) ?></small></div>
