...
<html lang="en">
    <head>
        <?php $title = "Success Mail"; include('/partials/title-meta.php'); ?> <?php include('/partials/head-css.php'); ?>
    </head>
                                            ...
                                            <div class="mb-4">
                                                <div class="avatar-xxl mx-auto mt-2">
                                                    <div class="avatar-title bg-light-subtle border border-light border-dashed rounded-circle">
                                                        <img src="../source/inspinia5/assets/images/checkmark.png" alt="dark logo" height="64" />
                                                    </div>
                                                </div>
                                            </div>
