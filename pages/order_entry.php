...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div data-table data-table-rows-per-page="10" class="card" id="orderEntryCard">
                    ...
                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0" id="api-orders">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><h5 class="fs-sm mb-0 fw-medium"><a href="#" class="link-reset order-detail-link" data-order-id="<?= htmlspecialchars($row['__kp_API_Input_Order_ID']) ?>">#<?= htmlspecialchars($row['__kp_API_Input_Order_ID']) ?></a></h5></td>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item order-detail-link" href="#" data-order-id="<?= htmlspecialchars($row['__kp_API_Input_Order_ID']) ?>">View order</a></li>
