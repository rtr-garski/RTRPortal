...
require_page_access('client_reports', $pdo2);
...
$lastLoc = !empty($locations) ? end($locations) : [];
?>
    ...
    <div class="page-title-head d-flex align-items-center">
        ...
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0">
                <li class="breadcrumb-item"><a href="#">RTR</a></li>
                <li class="breadcrumb-item"><a href="#" id="client-reports-back-btn">Order</a></li>
            ...
            <div class="card card-top-sticky">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <h5 class="card-title mb-0"><?= htmlspecialchars($order['Pat_Name']) ?></h5>
                    ...
                    <div class="list-group list-group-flush list-custom mt-3">
                        <div class="mb-2">
                            ...
                            <a href="#!" class="list-group-item list-group-item-action loc-trigger"
                                ...
                                data-loc-rec-type="<?= htmlspecialchars($loc['Rec_Type']) ?>"
                                data-loc-special="<?= htmlspecialchars($loc['Special_Instructions']) ?>"
                                ...
                                <span class="align-middle" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-placement="top" data-bs-html="true"
                                    title="<?= htmlspecialchars($loc['Rec_Type']) ?>"
        ...
        <div class="col-xl-9 order-xl-2 recordlocationhist d-none">
            <div class="card card-h-100 rounded-0 rounded-start">
                <div class="card-header align-items-start p-4">
                    ...
                    <div class="ms-auto">
                        <h6 class="mb-1 text-muted text-uppercase">Location Address</h6>
                        <p class="mb-0"><i class="ti ti-map-pin me-1"></i><span id="locDetailAddress"></span></p>
                        <p class="mb-0"><i class="ti ti-phone me-1"></i><span id="locDetailPhone"></span> &nbsp; <i class="ti ti-printer me-1"></i><span id="locDetailFax"></span></p>
                    </div>
                </div>
                    ...
                    <div class="card-body px-4">
                        <div class="row mb-4">
                            <div class="col-md-4 col-xl-3">
                                ...
                                <p class="fw-medium mb-0"><span class="badge badge badge-outline-purple" id="locDetailRecType"><?= htmlspecialchars($lastLoc['Rec_Type'] ?? '') ?></span></p>
                            </div>
                            <div class="col-md-4 col-xl-3">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted" id="locDetailSpecial"><?= htmlspecialchars($lastLoc['Special_Instructions'] ?? '') ?>Lorem Ipsum is dummy or placeholder text commonly used in graphic design, publishing, and web development to fill spaces where content will eventually appear.</p>
                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="notes" role="tabpanel">
                                <form action="#" class="mb-3">
                                    <div class="mb-3">
                                        <textarea class="form-control" rows="4" placeholder="Enter your messages..."></textarea>
                                    </div>
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-secondary btn-sm">
                                            Comment <i class="ti ti-send-2 align-baseline ms-1"></i>
                                        </button>
                                    </div>
                                </form>
                                ...
                                <div class="d-flex mb-2 border border-dashed rounded p-3">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h5 class="mb-1">Client 1 <small class="text-muted">14 Apr 2025 · 04:15PM</small></h5>
                                        ...
                                        <a href="javascript:void(0);" class="badge bg-light text-muted d-inline-flex align-items-center gap-1">
                                            <i class="ti ti-corner-up-left fs-lg"></i> Reply
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex mb-2 border border-dashed rounded p-3">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <h5 class="mb-1">Daniel West <small class="text-muted">12 Apr 2025 · 02:11PM</small></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h5 class="mb-1 fs-base"><a data-sort="name" href="#!" class="link-reset">Client Proposal PDF</a></h5>
                                                        ...
                                                        <td class="text-end pe-3">
                                                            <div class="d-flex align-items-center justify-content-end gap-2">
                                                                <div class="dropdown flex-shrink-0 text-muted">
                                                                    <a href="#" class="dropdown-toggle drop-arrow-none fs-xxl link-reset p-0" data-bs-toggle="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        ...
                                                                        <a href="assets/files/proposal.pdf" download class="dropdown-item"><i class="ti ti-download me-1"></i>Download</a>
