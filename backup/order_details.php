										...
										<div class="card-header align-items-start p-4">
											...
											<div class="ms-auto">
												<!-- <a href="javascript: void(0);" class="btn btn-light"><i class="ti ti-pencil me-1"></i> Modify</a> -->
												 <a href="javascript: void(0);" class="btn btn-success"><i class="ti ti-send me-1"></i> Test Api to API-RH</a>
												<a href="javascript: void(0);" class="btn btn-success"><i class="ti ti-send me-1"></i> Release the Kraken</a>
											</div>
										</div>
