...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'upload') {
    ...
    header('Location: file_manager.php?flash=' . urlencode($flash['type'] . '|' . $flash['msg']));
    exit;
}
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0"><i class="ti ti-upload me-1"></i> Upload File to Backblaze B2</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="file_manager.php" enctype="multipart/form-data" class="d-flex align-items-center gap-2">
            ...
            <div class="modal-body">
                ...
                <div id="presignResult" class="d-none">
                    <p class="text-muted fs-xs mb-2">
                        ...
                        <span id="presignExpiry" class="text-danger fw-semibold ms-1"></span>
                    </p>
                    ...
                    <div class="alert alert-warning mt-3 mb-0 py-2 fs-xs">
                        ...
                        Do not share this link publicly. It grants direct access to the file until it expires.
                    </div>
                </div>
            </div>
