										...
										<div class="card-body px-4">
											...
											<div class="row g-3 mb-4">
												<div class="col-md-3">
													...
													<?php /* TODO-VALID: remove id below when done */ ?>
													<input type="text" id="<?= uniqid('field_') ?>" class="form-control is-valid" value="<?= htmlspecialchars($order['_kf_Service_Type_ID_Str']) ?>" />
												</div>
												<div class="col-md-3">
											...
											<?php foreach ($order['insurance'] as $i => $ins): ?>
												...
												<div class="row g-3">
													<div class="col-md-4">
														...
														<?php /* TODO-VALID: remove id below when done */ ?>
													<input type="text" id="<?= uniqid('field_') ?>" class="form-control is-valid" value="<?= htmlspecialchars($ins['Ins_Name']) ?>">
													</div>
													<div class="col-md-6">
											...
											<?php foreach ($order['locations'] as $i => $loc): ?>
												...
												<div class="row g-3">
													...
													<div class="col-md-8">
														...
														<?php /* TODO-VALID: remove id below when done */ ?>
														<input type="text" id="<?= uniqid('field_') ?>" class="form-control mb-1 is-valid" value="<?= htmlspecialchars($loc['Loc_Name']) ?>">
